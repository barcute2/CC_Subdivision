/**
This program will create a three dimmensional letter I
and then, through repeated subdivisions, will create a smooth I
*/
...
//this struct will hold the info for an edge. It is not
//a half-edge, I have implemented it to my convenience
struct edge{
	int face1, face2;
...
//This class will store the date for our mesh, which will 
//then modify values in accordance to the subdivisions
class Mesh{
	public:
	...
	//This function will serve a pseudo-constructor purpose, it will basically set
	//whatever values I am passing in the init function
	...
	//After I pass in the known values for the initial I, this function will compute the edges
	void setUpEdges(){
	...
	//This is a helper function to determine the midpoints for each edge.
	//It will take the end-points and the face-points associated with the
	//adjacent surfaces.
	...
	//This function will create new surfaces after all the other data has been set up.
	//The function will then determine whether the points evaluated were stored or not
	//and add the new face to the corresponding vector
	void makeNewFaces(){
	...
	//Helper function to verify whether the point needs to be added or
	...
	//Function which will draw the mesh on the screen
	void draw(){
			//set up the lighting
...
//This function creates the face-points. They will be stored outside of the mesh 
//for convenience purposes, since they will not form new faces but are only used
//for averages
void addFacePoints(){
...
//This is the function that makes the subdivision. When the user presses "S"
